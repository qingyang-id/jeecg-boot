  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          add: "/order1/jshOrderProduct/add",
          edit: "/order1/jshOrderProduct/edit",
          queryById: "/order1/jshOrderProduct/queryById",
          jshOrderProductDetail: {
            list: '/order1/jshOrderProduct/queryJshOrderProductDetailByMainId'
          },
          jshOrderProductExtend: {
            list: '/order1/jshOrderProduct/queryJshOrderProductExtendByMainId'
          },
        }
      }
    },
