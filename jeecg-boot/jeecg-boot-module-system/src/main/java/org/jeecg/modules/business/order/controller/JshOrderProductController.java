...
@Slf4j
public class JshOrderProductController {
  @Autowired
  ...
  public Result<?> queryJshOrderProductExtendListByOrderId(@RequestParam(name = "id", required = true) Long orderId) {
    List<JshOrderProductExtend> jshOrderProductExtendList = jshOrderProductExtendService.selectByOrderId(orderId);
