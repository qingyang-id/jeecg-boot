  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/order11/jshOrderProduct/list",
          delete: "/order11/jshOrderProduct/delete",
          deleteBatch: "/order11/jshOrderProduct/deleteBatch",
          exportXlsUrl: "/order11/jshOrderProduct/exportXls",
          importExcelUrl: "order11/jshOrderProduct/importExcel",
        },
        dictOptions:{},
        superFieldList:[],
      }
