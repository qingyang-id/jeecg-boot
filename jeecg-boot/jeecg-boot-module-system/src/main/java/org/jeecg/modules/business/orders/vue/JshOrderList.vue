        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="客户id">
              <j-search-select-tag placeholder="请选择客户id" v-model="queryParam.customerId" dict="jsh_customer,name,id"/>
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            ...
            <a-col :xl="6" :lg="7" :md="8" :sm="24">
              <a-form-item label="地址">
                <j-search-select-tag placeholder="请选择地址" v-model="queryParam.address" dict=",,"/>
              </a-form-item>
            </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/orders/jshOrder/list",
          delete: "/orders/jshOrder/delete",
          deleteBatch: "/orders/jshOrder/deleteBatch",
          exportXlsUrl: "/orders/jshOrder/exportXls",
          importExcelUrl: "orders/jshOrder/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
         ...
         fieldList.push({type:'int',value:'totalPrice',text:'订单总额',dictCode:''})
         fieldList.push({type:'date',value:'orderTime',text:'下单时间'})
         fieldList.push({type:'sel_search',value:'address',text:'地址',dictTable:'', dictText:'', dictCode:''})
