...
@Slf4j
public class JshOrderController {
	@Autowired
   ...
   private IJshOrderProductDetailService jshOrderProductDetailService;
	...
	public Result<?> delete(@RequestParam(name="id",required=true) BigInteger id) {
	...
	public Result<?> queryJshOrderProductListByMainId(@RequestParam(name="id",required=true) BigInteger id) {
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, JshOrder jshOrder) {
      ...
      List<JshOrder> jshOrderList = new ArrayList<JshOrder>();
