  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          add: "/order10/jshOrderProduct/add",
          edit: "/order10/jshOrderProduct/edit",
          jshOrderProductDetail: {
            list: '/order10/jshOrderProduct/queryJshOrderProductDetailByMainId'
          },
          jshOrderProductExtend: {
            list: '/order10/jshOrderProduct/queryJshOrderProductExtendByMainId'
          },
        }
      }
    },
