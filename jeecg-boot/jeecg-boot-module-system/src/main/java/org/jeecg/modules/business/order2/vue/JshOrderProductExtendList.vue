...
<script>
  ...
  import JshOrderProductExtendModal from './modules/JshOrderProductExtendModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/business/order/jshOrderProduct/listJshOrderProductExtendByMainId",
          delete: "/business/order/jshOrderProduct/deleteJshOrderProductExtend",
          deleteBatch: "/business/order/jshOrderProduct/deleteBatchJshOrderProductExtend",
          exportXlsUrl: "/business/order/jshOrderProduct/exportJshOrderProductExtend",
          importUrl: "/business/order/jshOrderProduct/importJshOrderProductExtend",
        },
        dictOptions:{
        },
        superFieldList:[],
