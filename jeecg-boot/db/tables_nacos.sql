...
) ENGINE = InnoDB AUTO_INCREMENT = 4 COMMENT = 'config_info' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 COMMENT = '增加租户字段' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 COMMENT = 'config_info_beta' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 COMMENT = 'config_info_tag' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 COMMENT = 'config_tag_relation' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 COMMENT = '集群、各Group容量信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 COMMENT = '多租户改造' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 COMMENT = '租户容量信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tenant_info`  (
  ...
  INDEX `idx_tenant_id`(`tenant_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 COMMENT = 'tenant_info' ROW_FORMAT = Dynamic;
