<template>
  <a-card :bordered="false" :class="'cust-erp-sub-tab'">
    ...
    <jshOrderProductDetail-modal ref="modalForm" @ok="modalFormOk" :mainId="mainId"></jshOrderProductDetail-modal>
  </a-card>
</template>
...
<script>
  ...
  import JshOrderProductDetailModal from './JshOrderProductDetailModal'

  export default {
    name: "JshOrderProductDetailList",
    mixins:[JeecgListMixin],
    components: { JshOrderProductDetailModal },
    props:{
      mainId:{
        type:String,
        default:'',
    ...
    data () {
      return {
        ...
        url: {
          list: "/order6/jshOrderProduct/listJshOrderProductDetailByMainId",
          delete: "/order6/jshOrderProduct/deleteJshOrderProductDetail",
          deleteBatch: "/order6/jshOrderProduct/deleteBatchJshOrderProductDetail",
          exportXlsUrl: "/order6/jshOrderProduct/exportJshOrderProductDetail",
          importUrl: "/order6/jshOrderProduct/importJshOrderProductDetail",
        },
        dictOptions:{
        },
        superFieldList:[],
