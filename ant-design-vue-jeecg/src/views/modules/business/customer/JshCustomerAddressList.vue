...
import JshCustomerAddressModal from './modules/JshCustomerAddressModal';

export default {
  name: "JshCustomerAddressList",
  ...
  data() {
    return {
      ...
      url: {
        ...
        deleteBatch: "/business/customer/jshCustomer/deleteBatchJshCustomerAddress",
        exportXlsUrl: "/business/customer/jshCustomer/exportJshCustomerAddress",
        importUrl: "/business/customer/jshCustomer/importJshCustomerAddress",
      },
      dictOptions: {
        sex: [],
      },
